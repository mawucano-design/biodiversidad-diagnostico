...
def crear_capa_ui(capa_key, capa_config, datos, resultados, gdf, capa_index):
    ...
    try:
        ...
        with tab1:
            ...
            mapa_capa = crear_mapa_para_capa(gdf, datos[capa_key], capa_config, f"mapa_{capa_index}")
            if mapa_capa:
                st_folium(mapa_capa, width=800, height=500, key=f"mapa_{capa_index}")
...
def main():
    ...
    if poligono_cargado and not st.session_state.analysis_complete:
        st.markdown('<div class="custom-card">', unsafe_allow_html=True)
...
"""
    ...
    elif not poligono_cargado and not st.session_state.analysis_complete:
        st.markdown('<div class="custom-card">', unsafe_allow_html=True)
        st.markdown("""
